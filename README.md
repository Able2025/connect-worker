# WorkerConnect: Decentralized Collaboration Platform

A blockchain-powered platform that enables decentralized collaboration with milestone-based funding, ensuring transparent and accountable project completion between workers and project sponsors.

## Overview

WorkerConnect introduces a phased collaboration and funding release system where workers receive milestone-based compensation only after demonstrating verifiable progress. This approach revolutionizes decentralized work by:
...
(contract-call? .worker-connect create-project 
    "My Project" 
    "Description" 
...
;; Add a milestone
(contract-call? .worker-connect add-milestone 
    u1 ;; Project ID
    "Milestone 1" 
    "Description" 
...
;; Back a project
(contract-call? .worker-connect back-project 
    u1 ;; Project ID
